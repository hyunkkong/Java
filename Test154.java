...
public class Test154
{
	public static void main(String[] args)
	{
		...
		String val1 = (String)myStack.peek();		// Object 타입 , 다운캐스팅
		System.out.println("val1 : " + val1);
		//--==>>val1 : 조현하
		String val2 = (String)myStack.peek();		// peek : 스택에서 제거하지 않고 반환한다.
		System.out.println("val2 : " + val2);
		//--==>>val2 : 조현하
		String val3 = (String)myStack.peek();		// peek : 스택에서 제거하지 않고 반환한다.
		...
		// isEmpty()
		//is : ~인지 아닌지 , Empty : 비어있는지
		//									// 현하 미경 현성 시연 / 미경 현성 시연 / 현성 시연		 / 시연				/ (빈 공간)
