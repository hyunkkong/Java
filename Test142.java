...
/*
 ...
 ○ Calendar 클래스 객체(인스턴스)를 생성할 수 있는 방법
	...
	2. Calendar 0b2 = new GregorianCalendar();		//업캐스팅
...
public class Test142
{
	public static void main(String[] args)
	{
		...
		int y = rightNow.get(Calendar.YEAR);					//YEAR 상수 static final
		System.out.println("y : "+ y);
		//--==>> y : 2022

		int m = rightNow.get(Calendar.MONTH) + 1;				//-- 『+1』 check~!!!	배열형태로 저장되어있음
