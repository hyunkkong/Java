...
○ 『extends』 vs 『implements』
 ...
 ※ 인터페이스의 멤버 변수인 데이터는
 	접근제어지시자를 별도로 명시하지 않더라도 기본 상수(primitive constant)인
...
// 인터페이스(ADemo,BDemo)를 상속받는 인터페이스
interface BDemo 
{
	public void print();
}
...
// class DemoImpl
//		↓
// 인터페이스(ADemo,BDemo)를 상속받은 인터페이스(CDemo)를 구현한 
//abstract class DemoImpl implements CDemo
//
// 클래스
// 인터페이스(ADemo,BDemo)를 상속받은 인터페이스(CDemo)를 구현한 후
// 모든 메소드를 재정의한 
...
public class Test120
{
	public static void main(String[] args)
	{
		...
		// 해당 인터페이스의 메소드 뿐 아니라
		// 상속받은 인터페이스의 모든 메소드를 재정의한 클래스 기반의 인터페이스 생성
