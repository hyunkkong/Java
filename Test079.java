...
○ 배열의 개요
	...
	1. 배열이란 크기와 성경이 같은 일련의 원소들이 모여
	   공동의 집합 구조를 갖는 자료의 집합체를 의미하는 것으로
	   『동질적인 성격을 가진 자료들』에 대해
	   개별적이로 자료형(Data Type)을 부여하지 않고
	   하나의 이름을 가지고 일괄적으로 처리할 목적으로 사용된다.

	2. 자바에서의 배열은 다음과 같은 수선에 의해 사용된다.
...
public class Test079
{
	public static void main(String[] args)
	{
		...
		// 메모리 할당 및 초기화가 가능하다.
		int[] arr2 = new int[10];
		int[] arr3 = {1,2,3,4,5,6,7,8,9,0};  // 일반적으로 사용
		int arr4[] = {1,2,3,4,5,6,7,8,9,0};  // 문법적으로 사용
		...
		//	  비어있는 것이 아니라 자동을 초기화된다. → 0 (int형 배열)
