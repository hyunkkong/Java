...
public class Test116
{
	public static void main(String[] args)
	{
		...
		포유류 사람 = 현성이;	『포유류 사람 = (사람) 현성이;』와 동일한 코드

		※ 학생도 포유류
		
		※ class 포유류			class 학생 extens 포유류
		   {					{
		   }					}
		...
		*/
		...
		//--==>> 서브 클래스 print() 메소드...
		//java에서의 하위클래스는 상위클래스의 정보를 담고있어 알아볼 수 있지만
		// 반대로 상위클래스는 하위클래스를 알아볼 수 없다.
...
부모와 자식의 정보를 둘다가진 ob1을 부모클래스로 격상시켜서 만든게 ob2니까
ob2에는 부모와 자식의 정보가 둘다 들어가있어 자식클래스로의 다운도 가능하다.
