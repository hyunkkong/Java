...
public class Test115 extends SortInt115
{
	...
	{
		//selection sort
		for (i=0;i<data.length-1 ;i++ )	//for (i=0;i<dataLength()-1 ;i++ )
		{
			for (j=i+1;j<data.length ;j++ ) //for (j=i+1;j<dataLength() ;j++ )
			{
				//크기 비교
				if (compare(i,j)>0)
				{
