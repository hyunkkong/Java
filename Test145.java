...
○ java.lang.Math 클래스의 주요 상수 및 메소드
	...
	- public static double toDegrees(double angrad)
	  :라디안(radian)를 각도(angdeg)로 바꾸어 반환한다.

	- public static double exp(double a)
	  : e 의 a 승을 구하여 반환한다.
	- public static double lag(double a)
	  : 로그(log) 값을 구하여 반환한다.
...
public class Test145
{
	public static void main(String[] args)
	{
		...
		//--==>>0.0 - 1.0 사이의 난수 : 0.7424996416657338
		//		0.0 - 1.0 사이의 난수 : 0.7029988340623569
		//		0.0 - 1.0 사이의 난수 : 0.0942404640008232
		//		0.0 - 1.0 사이의 난수 : 0.40598577286123616
