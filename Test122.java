...
○ 중첩 클래스의 종류(4가지)
	...
	1. static 중첩 클래스(중첩 내부 클래스)
	   ...
	   - 프로그램의 구조를 보다 더 간단하고 알아보기 쉽게 구성할 수 있따.
	...
	2. 내부 클래스(inner class)
	   ...
	   - static 중첩 클래스와 마찬가지로 프로그램 구조를 보다 더 간단하고
	     알아보기 쉽도록 한 것이다.
	   - 외부 클래스의 메소드에서 내부 멤버 클레스를 사용하기 위해서는
