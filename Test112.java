...
//	현재 클라스가 상속받은 상위 클래스의 객체를 가리킨다.
//	super 는 사우이 클래스의 생성자를 호출하거나
...
//Rect112클래스 와 Circle112 클래스의 부모 클래스
class SuperTest112
{
...
class Rect112 extends SuperTest112
{
	...
	// ※ 메소드 오버라이딩(Method Overriding)  -- 상속을 위한 문법
	...
	public void write()  // 상속받은 write()와 오버라이딩되서 가능
	{
...
// SuperTest112 클래스를 상속받는 자식 클래스(단일 상속)
class Circle112 extends SuperTest112		// 다중 상속이 아님
{
	// 자식 클래스의 사용자 정의 생성자
...
================================================================================================
생성자를 정의하지 않음 = 인수가 없는 생성자만 정의 (같다)
default 생성자는 인수가 없는 형태로 생성된다.
*/