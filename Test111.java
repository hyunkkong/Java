...
○ 상속(Inheritance)이란
	...
	객체 간의 관계를 구성함으로써
	객체 지향의 또 다른 특징인 『다향성』의 문법적 토대가 된다.
...
※ 주의할 점
	...
	두 개 이상의 클래스로부터 상속받을 순 없다.

	자바는 『단.일.상.속』만 지원한다.

*/

// 실무에서의 상속은 가이드라인을 제시하는 관점에서 사용된다.
// 상속을 코드의 재사용, 재활용의 관점에서 이해하려고 하지말자.

// 부모 클래스 == 상위 클래스 == Super 클래스 == 물려주는 클래스 == 상속하는 클래스
// 접근제어지시자 protected : 상속을 염두해두고 만든 클래스
class SuperTest111
{
